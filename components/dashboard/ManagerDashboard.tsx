      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          <div className="flex items-center justify-between text-slate-500 uppercase tracking-wider text-[10px] font-bold">
            <span className="group-hover:text-slate-900 transition-colors">My Team Leaders</span>
        ...
        >
          <div className="flex items-center justify-between text-slate-500 uppercase tracking-wider text-[10px] font-bold">
            <span className="group-hover:text-slate-900 transition-colors">My Team Employees</span>
            <UserCheck className="w-4 h-4 text-slate-400 group-hover:text-slate-700 transition-colors" />
          </div>
          <div className="flex items-baseline justify-between mt-2">
            <div className="text-3xl font-black text-slate-900 font-mono">
        ...
        >
          <div className="flex items-center justify-between text-slate-500 uppercase tracking-wider text-[10px] font-bold">
            <span className="group-hover:text-indigo-600 transition-colors">Company Manager Tasks</span>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-2xs space-y-4">
          ...
          <div className="space-y-3 text-xs font-bold">
            ...
            >
              ...
              <span>Team Leader & Employee Performance</span>
            </Link>

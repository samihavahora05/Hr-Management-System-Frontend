...
export function HRDashboard({ leaveRequests }: HRDashboardProps) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl p-6 shadow-2xs space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/hr/tasks" className="text-xs font-bold text-[#0f365e] hover:underline">
              View All Tasks &rarr;
            </Link>
          </div>
